package com.lzy.serverproject.AI;
...
public class BigModelNew extends WebSocketListener {
    ...
    public static final String hostUrl = AIConstant.AIHTTPURL;
    public static final String appid = AIConstant.appID;
    public static final String apiSecret = AIConstant.appSecret;
    public static final String apiKey = AIConstant.appKey;
    ...
    public static Boolean isAllAnswer = false;
    ...
    public static String getAIContent(String content){
        totalAnswer="";
        isAllAnswer=false;
